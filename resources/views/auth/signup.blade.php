...
<section class="bg-gray-50 dark:bg-gray-900 section-bg">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0">
        <div class="mb-5">
            <img class="ytc-logo mx-auto" src="{{asset('assets/img/ytc-logo.png')}}" alt="logo">
        </div>
        <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            Young Torivenians Club - YTC
        </a>
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    <div>
                        <label for="username" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Uername</label>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                <label for="remember" class="text-gray-500 dark:text-gray-300">I agree to the <a href="#" class="font-medium text-[#3581F6] hover:underline">terms and condition</a></label>
                            </div>
                        </div>
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Already have an account? <a href="{{ route('signin') }}" class="font-medium text-[#3581F6] hover:underline"> Sign in here</a>
                    </p>
                </form>
            </div>
        </div>
